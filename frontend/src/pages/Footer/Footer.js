        ...
        <div className="footerCmp">
            <footer>
                ...
                <div className="footerGetInTouch">
                    <h1>Get in touch</h1>
                    <ul>
                        <p>Any questions? Let us know mmuqtasid875@gmail.com or call us on +9233500007007</p>
                ...
                <div className="paragraphFooter"><p>Copyright ©2023 All rights reserved | Developed by Muqtasid</p>
                <Link to = '' >HOME</Link>
                <Link to = ''  >SHOP</Link>
                <Link to = ''  >ABOUT</Link>
                </div>
